...
class ViewController: NSViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let centralQueue: DispatchQueue = DispatchQueue(label: "com.actiontec.centralQueueName", attributes: .concurrent)
    ...
    func moveServo(id: UInt, angle: Double, time: UInt) -> Void {
        ...
        _peripherals![0].writeValue(data as Data, for:_char!, type: CBCharacteristicWriteType.withResponse)
    }
}
